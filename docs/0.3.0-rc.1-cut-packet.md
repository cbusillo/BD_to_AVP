...
Beta 12 build `157`, and burned builds `147` and `154`. RC 1 is immutable
published history; RC 2 is the next candidate.
...
evidence only; RC 2 must complete its own fresh qualification.
