...
`0.3.3b4` / build `175` are published and immutable; Beta 4's qualification is
complete in issue #779. Issue #793 owns prepared successor Beta `0.3.3b5`,
public tag `v0.3.3-beta.5`, and build `176`, recorded in
[the Beta 5 cut packet](0.3.3-beta.5-cut-packet.md). Its metadata and
