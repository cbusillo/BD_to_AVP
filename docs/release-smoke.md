...
2. Run the Prerelease metadata policy with the committed target and confirm the
   RC 3 freeze is absent while all route, identity, and existing-release
   guards remain active before packaging or signing.
3. Validate a cumulative appcast fixture ordered RC 3 build `160`, RC 2 build
   `159`, RC 1 build `158`, Beta 11
