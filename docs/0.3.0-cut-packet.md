...
RC3-to-Stable Sparkle route, clean-machine update, and installed UI
accessibility remain blocking post-publication evidence because they bind the
published Stable DMG, checked receipt, and live appcast. Native release-note
presentation plus USB Blu-ray/MakeMKV, protected-media conversion, and Vision
Pro playback remain visible nonblocking operational evidence. Missing, failed,
skipped, or due operator evidence must remain honest and never become a
fabricated pass or a substitute for automated qualification.
