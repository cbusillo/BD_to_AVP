...
def evaluate_confirmation(
    ...
    return evaluate_mapping_confirmation(
        plan,
        evidence,
        source_receipts,
        MappingEvaluationSpec(
            ...
            balanced_candidate_id="q070",
            maximum_candidate_id="q085",
            maximum_size_ratio=plan.thresholds.maximum_q085_to_q070_size_ratio,
            selection_policy="fixed_contiguous_subset_containing_q070",
            expected_record_count=147,
            retained_anchor_artifacts=source_receipts["automated_full_length_anchor"],
