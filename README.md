...
RC 1 (`0.3.0rc1`, build `158`) is published and immutable. RC 2 metadata
(`0.3.0rc2`, build `159`) is prepared for the guarded Prerelease workflow.
There is no RC 2 tag, DMG, release, or updater item until exact-SHA signing,
